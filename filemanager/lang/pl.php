...
return array(
	...
	'Upload_base_help' => "Przecięgnij plik (nowoczesne przeglądarki) albo kliknij przycisk u góry aby dodać plik. Kiedy plik zostanie wrzucony, kliknij przycisk 'Powrót do listy plików'",
	'Upload_add_files' => 'Dodaj pliki',
	'Upload_start' => 'Wrzuć plik',
	'Upload_error_messages' =>array(
		1 => 'Wrzucany plik przekracza post_max_size określony w php.ini',
		2 => 'Wrzucany plik przekracza MAX_FILE_SIZE okreslony w HTML form',
		3 => 'Wrzucony plik tylko w części',
		4 => 'Żaden plik nie został wrzucony',
		6 => 'Brak folderu tymczasowego',
		7 => 'Niepowodzenie zapisu pliku na dysk',
		8 => 'Rozszerzenie PHP zatrzymało przesyłanie pliku',
		'post_max_size' => 'Wrzucany plik przekracza post_max_size określony w php.ini',
		'max_file_size' => 'Plik zbyt duży',
		'min_file_size' => 'Plik zbyt mały',
		'accept_file_types' => 'Typ pliku niedozwolony',
		'max_number_of_files' => 'Przekroczona maksymalna ilość plików',
		'max_width' => 'Obraz przekracza max szerokość',
		'min_width' => 'Obraz przekracza min szerokość',
		'max_height' => 'Obraz przekracza max wysokość',
		'min_height' => 'Obraz przekracza min wysokość',
		'abort' => 'Wrzucanie pliku przerwane',
		'image_resize' => 'Niepowodzenie w zmianie rozmiaru'
	),
	'Upload_url' => 'From url',
	'Type_dir' => 'FLD',
	'Type' => 'Roz.',
